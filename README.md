...
- TypeScript (fundamentos + modelagem + classes)
- Jest (testes unitários: services, components, forms)
- Eventos, Formulários (Reactive Forms), Consumo de APIs, RxJS

## Roadmap (10 semanas)
- Semanas 1–2: Setup + TypeScript Fundamentals
- Semanas 3–4: Angular Fundamentals (components, templates, events)
- Semanas 5–6: Reactive Forms + Validators (regras de negócio)
- Semanas 7–8: HTTP + RxJS + CRUD (loading/error, interceptors)
- Semana 9: Arquitetura (modules, routing, guards, resolver, lazy load)
...
- Testes como contrato (AAA: Arrange-Act-Assert)
